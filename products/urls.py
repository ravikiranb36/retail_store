...
from .views import PriceFeedCSVUploadView, PriceFeedView, PriceFeedSearchView, CSVTaskStatusView, StoreListCreateView, StoreDetailView, PriceFeedDetailView
...
urlpatterns = [
    ...
    path('price-feed/<int:pk>/', PriceFeedDetailView.as_view(), name='price_feed_detail'),
